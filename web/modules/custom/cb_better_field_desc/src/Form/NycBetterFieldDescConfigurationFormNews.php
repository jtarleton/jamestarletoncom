...
/**
 * Class NycBetterFieldDescConfigurationFormNews.
 */
class NycBetterFieldDescConfigurationFormNews extends NycBetterFieldDescConfigurationForm {
  ...
  public function __construct(
    ...
    //$this->contentType = $this->allContentTypes[2];
