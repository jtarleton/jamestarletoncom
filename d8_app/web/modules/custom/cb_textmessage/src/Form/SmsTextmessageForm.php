 ...
 */
class SmsTextmessageForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $form['sms']['smsMessage'] = [
      '#type' => 'textarea',
      '#title' => $this->t('Your Message to James'),
      '#default_value' => 'hey James!' //$this->config('cb_textmessage.settings')->get('smsMessage'),
    ];
...
foreach(['robotChallenge','smsMessage'] as $k=>$v) {
