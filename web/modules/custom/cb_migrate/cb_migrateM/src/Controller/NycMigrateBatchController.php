 ...
 */
class NycMigrateBatchController extends ControllerBase {

  /**
   * Builds the response.
   */
  public function build() {
    self::executeOverviewBatchProcess();
  ...
  public static function executeOverviewBatchProcess() {
    ...
    while ($offset < (int) $ct && ((int) $ct < $limit)) {
      if (!empty($batch_node_ids)) {
        ...
        $batch_operations[] = ['nyc_migrate_do_update', [$node_batch]];
      }
    }
    $batch = array(
